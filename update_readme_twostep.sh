...
echo ">>> 1. 正在重写白皮书 (README.md)：回归极简两步部署法..."
...
echo ">>> 2. 正在提交并强推 README 更新至 GitHub..."
git add README.md
git commit -m "📝 [Docs] 重构 README：明确提供小白专属的两步极简部署指令" || true
git push origin crystal -f

echo "========================================================="
echo " ✅ README 已完美更新！两步部署文档已上线 GitHub！"
echo "========================================================="
